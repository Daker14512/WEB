...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm stick-stop">
        <div class="container-fluid">
            <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">Dallas Hotel</a>
        ...
        <div class="col-lg-12 bg-white shadow p-4 rounded">
            ...
            <form>
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-1">
                        <button type="submit" class="btn text-while shadow-none">Submit</button>
                    </div>
                </div>
            </form>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <span class="badge rounded-pill bg-light text-dark mb-3 text-warp lh-base">
                            Note: Your details must match with your ID (Citizen identification, passport, driving
                            license, etc.) that wwill required check-in.
                        </span>
                        <div class="container-fluid">
                            <div class="row">
